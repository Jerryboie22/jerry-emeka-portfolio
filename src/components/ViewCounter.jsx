...
export default function ViewCounter() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 hidden sm:flex items-center gap-2 px-4 py-2 rounded-full glass-strong shadow-premium font-mono text-xs max-w-[calc(100vw-2rem)]"
    >
